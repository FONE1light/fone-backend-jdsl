...
data class NotFoundUserException(override val message: String = "존재 하지 않는 유저 입니다.") : ServerException(200, message)
...
data class NotFoundProfileException(override val message: String = "존재 하지 않는 프로필 입니다.") : ServerException(200, message)
