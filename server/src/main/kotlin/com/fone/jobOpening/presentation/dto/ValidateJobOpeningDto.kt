...
class ValidateJobOpeningDto {
    ...
    data class ThirdPage(
        ...
        @Schema(description = "최대 나이 (최대,최소 둘다 null이면 연령무관, '끝'이면 null로 전달)", example = "40")
        @ApiModelProperty(value = "최대 나이 (최대,최소 둘다 null이면 연령무관, '끝'이면 null로 전달)", example = "40")
        val ageMax: Int?,

        @Schema(description = "최소 나이 (최대,최소 둘다 null이면 연령무관, '시작'이면 null로 전달)", example = "20")
        @ApiModelProperty(value = "최소 나이 (최대,최소 둘다 null이면 연령무관, '시작'이면 null로 전달)", example = "20")
        val ageMin: Int?,
